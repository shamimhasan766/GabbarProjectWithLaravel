    ...
    <div class="container mt-120">
        <div class="row">
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td>{{$sl+1}}</td>
                                  <td><img src="{{$service->image}}" height="60" alt=""></td>
                                  <td class="editable title">{{$service->title}}</td>
                                  <td class="editable desc">{{$service->desc}}</td>
                                  <td>
                                    <div class="d-flex">
                                      <button style="margin-right: 5px" value="{{$service->id}}" class="btn btn-primary shadow btn-xs sharp mr-1 edit-row"><i class="fa fa-pencil"></i></button>
                                        <a data-id="" href="{{ route('deleteservice', ['id' => $service->id]) }}" class="delete btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                                </tr>
            ...
            <div class="col-lg-4">
              ...
              @endif
                <div class="card">
                    <div class="card-header text-center">Add Service</div>
                    <div class="card-body">
                        <form action="{{route('addservice')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                            <div class="mb-3">
                                <img id="blah" src="" alt="" width="150px">
                              <label class="form-label d-block">Service Image</label>
...
$(document).ready(function() {
    ...
    $('.table').on('click', '.save-row', function() {
      ...
      $.ajax({
          type: 'POST',
          url: '/edit_service', // PHP script to handle database update
          data: {
              id: id,
              values: editedValues
          },
