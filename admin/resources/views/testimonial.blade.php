                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="d-flex">
                                            <button style="margin-right: 5px" value="{{$testimonial->id}}" class="btn btn-primary shadow btn-xs sharp mr-1 edit-row"><i class="fa fa-pencil"></i></button>
                                            <a data-id="" href="{{ route('deletetestimonial', ['id' => $testimonial->id]) }}" class="delete btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                    </tr>
...
<script>
  $(document).ready(function() {
      ...
      $('.table').on('click', '.save-row', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '/edit_testimonial', // PHP script to handle database update
            data: {
                id: id,
                values: editedValues
            },
